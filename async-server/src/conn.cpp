...
int fork_conn()
{
    ...
    tcp_accept.set_keepalive(g_plugin.config_get_intval("tcp_keepalive", 1));
    tcp_accept.start(get_bind_ip(), g_plugin.config_get_intval("bind_port", 0));
