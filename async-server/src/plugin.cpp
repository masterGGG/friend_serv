...
int plugin_load(const char *filename)
{
    ...
    PLUGIN_LOADFUN(g_plugin.load_config, "load_config");
    PLUGIN_LOADFUN(g_plugin.reload_config, "reload_config");
    PLUGIN_LOADFUN(g_plugin.config_get_intval, "config_get_intval");
    PLUGIN_LOADFUN(g_plugin.config_get_strval, "config_get_strval");
    PLUGIN_LOADFUN(g_plugin.set_config, "set_config");
    ...
    PLUGIN_LOADFUN_IGNORE(g_plugin.link_up_ser, "link_up_ser");
